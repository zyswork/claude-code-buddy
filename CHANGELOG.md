...
## v1.0.0 · 2026-04-22 — 正式发布 🎉

历经 10 次版本迭代，claude-buddy 达到正式发布状态。

### 新增旗舰功能

- **`/buddy-insight`** — 基于 7 天事件日志 + 记忆 + 当前状态，让伙伴生成 200-350 字观察报告。结构：整体观察 / 想说的话 / 给主人的建议 / 结尾吐槽。事件总线的最终归宿——**伙伴真的能反思你**。

### 质量保障

- **44 项 smoke 测试**覆盖所有 lib/ 核心纯函数：roll 确定性、sprite 12 列对齐（含 28 角色）、progression 等级曲线、quip-buffer、events、mood、achievements/unlocks、easter-eggs、seasons。
- **GitHub Actions CI**：每次 push/PR 在 Node 20 和 22 上跑测试。
- **README 重写**：4 大分类、24 条命令归类、完整隐藏角色表、季节皮肤列表、快速上手、开发指南。
- **新文档 `docs/COMMANDS.md`**：完整命令参考手册。

### 最终数据

- ✅ **24 条 slash command**
- 🐾 **28 种图鉴角色**（18 原生 + 10 隐藏）
- 🏆 **12 个成就**
- 🎭 **8 种心情**
- 📅 **11 个节日皮肤**
- 🔮 **7 条 Konami 密语**
